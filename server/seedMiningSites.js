...
const MINING_SITES = [
  ...
  { name: 'Bratsk', region: 'europe', country: 'RU', lat: 56.13, lng: 101.61, hashrate: 520, price: 85, emoji: '\u2744' },
  { name: 'Krasnoyarsk', region: 'europe', country: 'RU', lat: 56.01, lng: 92.87, hashrate: 460, price: 80, emoji: '\u2744' },
  { name: 'Irkutsk', region: 'europe', country: 'RU', lat: 52.30, lng: 104.30, hashrate: 490, price: 78, emoji: '\u2744' },
  { name: 'Norilsk', region: 'europe', country: 'RU', lat: 69.35, lng: 88.20, hashrate: 300, price: 70, emoji: '\u2744' },
  ...
  { name: 'Tbilisi', region: 'europe', country: 'GE', lat: 41.72, lng: 44.79, hashrate: 180, price: 65, emoji: '\u2744' },
  { name: 'Yerevan', region: 'europe', country: 'AM', lat: 40.18, lng: 44.51, hashrate: 150, price: 58, emoji: '\u2744' },
  ...
  { name: 'Kyiv', region: 'europe', country: 'UA', lat: 50.45, lng: 30.52, hashrate: 210, price: 62, emoji: '\u2744' },
  // === ASIA (25 sites) ===
  ...
  { name: 'Novosibirsk', region: 'asia', country: 'RU', lat: 55.03, lng: 82.92, hashrate: 390, price: 75, emoji: '\uD83C\uDFED' },
  { name: 'Chelyabinsk', region: 'asia', country: 'RU', lat: 55.15, lng: 61.43, hashrate: 310, price: 70, emoji: '\uD83C\uDFED' },
  ...
  { name: 'Vladivostok', region: 'asia', country: 'RU', lat: 43.12, lng: 131.87, hashrate: 260, price: 72, emoji: '\uD83C\uDFED' },
  // === MIDDLE EAST (12 sites) ===
  { name: 'Abu Dhabi', region: 'middle_east', country: 'AE', lat: 24.45, lng: 54.65, hashrate: 500, price: 150, emoji: '\uD83C\uDFDC' },
  { name: 'Dubai', region: 'middle_east', country: 'AE', lat: 25.20, lng: 55.27, hashrate: 450, price: 145, emoji: '\uD83C\uDFDC' },
  { name: 'Ras Al Khaimah', region: 'middle_east', country: 'AE', lat: 25.79, lng: 55.94, hashrate: 320, price: 125, emoji: '\uD83C\uDFDC' },
  { name: 'Riyadh', region: 'middle_east', country: 'SA', lat: 24.71, lng: 46.68, hashrate: 380, price: 130, emoji: '\uD83C\uDFDC' },
  { name: 'Dammam', region: 'middle_east', country: 'SA', lat: 26.43, lng: 50.10, hashrate: 290, price: 110, emoji: '\uD83C\uDFDC' },
  { name: 'Muscat', region: 'middle_east', country: 'OM', lat: 23.59, lng: 58.38, hashrate: 240, price: 100, emoji: '\uD83C\uDFDC' },
  { name: 'Doha', region: 'middle_east', country: 'QA', lat: 25.29, lng: 51.53, hashrate: 310, price: 120, emoji: '\uD83C\uDFDC' },
  { name: 'Kuwait City', region: 'middle_east', country: 'KW', lat: 29.38, lng: 47.99, hashrate: 260, price: 115, emoji: '\uD83C\uDFDC' },
  { name: 'Tehran', region: 'middle_east', country: 'IR', lat: 35.69, lng: 51.39, hashrate: 350, price: 45, emoji: '\uD83C\uDFDC' },
  { name: 'Isfahan', region: 'middle_east', country: 'IR', lat: 32.65, lng: 51.68, hashrate: 280, price: 40, emoji: '\uD83C\uDFDC' },
  { name: 'Bahrain Manama', region: 'middle_east', country: 'BH', lat: 26.23, lng: 50.59, hashrate: 200, price: 105, emoji: '\uD83C\uDFDC' },
  { name: 'Amman', region: 'middle_east', country: 'JO', lat: 31.95, lng: 35.93, hashrate: 150, price: 80, emoji: '\uD83C\uDFDC' },
  ...
  // === OCEANIA (5 sites) ===
  { name: 'Sydney', region: 'oceania', country: 'AU', lat: -33.87, lng: 151.21, hashrate: 200, price: 110, emoji: '\uD83C\uDFDD' },
  { name: 'Melbourne', region: 'oceania', country: 'AU', lat: -37.81, lng: 144.96, hashrate: 180, price: 105, emoji: '\uD83C\uDFDD' },
  { name: 'Perth', region: 'oceania', country: 'AU', lat: -31.95, lng: 115.86, hashrate: 160, price: 95, emoji: '\uD83C\uDFDD' },
  { name: 'Auckland', region: 'oceania', country: 'NZ', lat: -36.85, lng: 174.76, hashrate: 140, price: 90, emoji: '\uD83C\uDFDD' },
  { name: 'Queenstown NZ', region: 'oceania', country: 'NZ', lat: -45.03, lng: 168.66, hashrate: 120, price: 85, emoji: '\uD83C\uDFDD' },
];
